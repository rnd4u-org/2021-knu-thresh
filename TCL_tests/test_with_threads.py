...
def decrypt_message_multi_threading(k, encrypted_message, shares, key_shares, threshold_params, key_params):
    partial_decryptions = []
...
time.perf_counter()
decrypted_message = decrypt_message_multi_threading(3, encrypted_message, (0, 2, 1), key_shares, thresh_params,
                                                    key_params)
t = time.process_time()
